...
public class PersonnelInformationTableController {
    ...
    public Lay savePersonnelInformation(
        ...
        String personId = personnelInformationService.savePerson(personGetAllVo);
...
//    public Lay selectPerson(@RequestBody PersonQueryVo personQueryVo){
//
//        Long limit = personQueryVo.getLimit();
//        Long page = personQueryVo.getPage();
//        if (null!=personQueryVo.getResId()) {
//            IPage<PersonGetAllVo> getAllVoList = personnelInformationService.selectResPerson(page, limit, personQueryVo);
//            long total = getAllVoList.getTotal();
//            List<PersonGetAllVo> records = getAllVoList.getRecords();
//            this.fmtIdCardToExcelExport(records);
//            return Lay.ok().count(total).data(records);
//        }
//        if (null!=personQueryVo.getTowId()) {
//            IPage<PersonGetAllVo> getAllVoList = personnelInformationService.selectTowPerson(page, limit, personQueryVo);
//            long total = getAllVoList.getTotal();
//            List<PersonGetAllVo> records = getAllVoList.getRecords();
//            this.fmtIdCardToExcelExport(records);
//            return Lay.ok().count(total).data(records);
//        }
//        if (null!=personQueryVo.getDisId()) {
//            IPage<PersonGetAllVo> getAllVoList = personnelInformationService.selectDisPerson(page, limit, personQueryVo);
//            long total = getAllVoList.getTotal();
//            List<PersonGetAllVo> records = getAllVoList.getRecords();
//            this.fmtIdCardToExcelExport(records);
//            return Lay.ok().count(total).data(records);
//        }
//            IPage<PersonGetAllVo> getAllVoList = personnelInformationService.selectAll(page, limit, personQueryVo);
//            long total = getAllVoList.getTotal();
//            List<PersonGetAllVo> records = getAllVoList.getRecords();
//            this.fmtIdCardToExcelExport(records);
//            return Lay.ok().count(total).data(records);
//    }
    ...
    private void fmtIdCardToExcelExport(List<PersonGetAllVo> records){
